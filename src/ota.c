...
#define UPDATE_JSON_URL		"http://sns.ee.sharif.ir/firmware.json"
#define BLINK_GPIO 			GPIO_NUM_26

// server certificates
extern const char server_cert_pem_start[] asm("_binary_src_certs_pem_start");
extern const char server_cert_pem_end[] asm("_binary_src_certs_pem_end");
